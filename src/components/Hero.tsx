...
import { ArrowRight, Mail, Code2, Sparkles, Download, Trophy } from "lucide-react";
        ...
        <div className="text-center max-w-5xl mx-auto">
          ...
          >
            ...
            <h1 className="text-6xl sm:text-7xl lg:text-8xl font-bold mb-6 tracking-tight">
              ...
              <span className="block text-gradient mt-2">Fast, Scalable</span>
              <span className="block text-gradient">Websites for Businesses</span>
            </h1>
          </motion.div>
          ...
          >
            Full-Stack Developer specializing in React, WordPress & Node.js. I turn business ideas
            into fast, conversion-ready web solutions.
          </motion.p>
